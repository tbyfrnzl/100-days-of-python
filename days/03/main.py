...
direction = input("You're at a crossroad. Where do you want to go? Type 'right' or 'left'. ").lower()

if direction == "right":
    action = input("After walking for some time, you hear a loud roar. Suddenly a lion shows up. What do you do? Type 'climb' to try to climb a nearby tree or 'run' to run as fast as possible. ").lower()
    ...
    if action == "wait":
        door = input("You take the boat and arrive at the island unharmed. There is a house with 3 doors. One red, one yellow and one blue. Which colour do you choose? ").lower()
